...
export default function Home() {
  return (
    <article className="article">
      <header>
        <h1>How can you write a decent title for your okay article</h1>
        <p>
          And also it would really really cool sub title for you really really
          decent title for that okay article which you wrote just now
        </p>
        <hr />
      </header>
